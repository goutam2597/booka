...
import '../../../../network_service/pgw_services/nowpayments.dart';
...
class NowPaymentsController {
  static Future<void> pay(BuildContext context, PaymentContext pc) async {
    ...
    await shared.runHostedGateway(
      context: context,
      gateway: GatewayType.nowPayments,
      openingLabel: 'NOWPayments',
      methodLabel: 'NOWPayments',
      openAndConfirm: (ctx, merged, major, minor, selectedCcyLower) async {
        return NowPaymentsGateway.startCheckout(
          context: ctx,
          amountMinor: minor,
