...
import '../../../../network_service/pgw_services/toyyibpay.dart';
...
class ToyyibpayController {
  ...
  overlay.update(PaymentStrings.finalizingBooking);
      ...
      pc.onComplete('Toyyibpay', bookingId);
      pc.onSuccessToast();
    } on TimeoutException {
